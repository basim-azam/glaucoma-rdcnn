...
\midrule
\rowcolor{ourrow}
\textbf{\textcolor{ourbold}{CD-Former (ours)}} & \textbf{96.75} & \textbf{90.57} & \textbf{0.990} & \textbf{0.052} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\rowcolor{ourrow}
\textbf{\textcolor{ourbold}{CD-Former (ours)}} & \underline{95.31} & \underline{75.36} & \textbf{0.961} & \textbf{0.076} \\
\bottomrule
\end{tabular}
\end{table}
